...
/*********************************************************************************************************************************************************************************/
  double E;                        // Energy conservation term that will be updated before each step
  double beta;                     // Energy conservation scaling coefficient
  int cons_step_num;                    // Number of time steps the energy conservation term will be updated
/*********************************************************************************************************************************************************************************/
